...
/**
 * ResponsiveDialog (Revola) - Compatible con la API de tweakcn.
 * En esta implementación usa Dialog de Radix. Para comportamiento
 * responsive (drawer en móvil) se puede añadir vaul.
 */
